...
public class SpawnManager : MonoBehaviour
{
    ...
    private TrollGiant GetEnableMonster()
    {
    ...
    bool DisactivateMob(Collider col)
    {
        try
        {
            TrollGiant disactivate = GameManager.instance.Monsters.Find(
                (x) => x.Equals(col.gameObject.GetComponent<TrollGiant>())
            );
